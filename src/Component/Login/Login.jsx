...
const Login = () => {
    ...
    return (
        <div className="flex justify-center min-h-screen bg-gray-100"> 
            <div className="container sm:mt-4 shadow-2xl rounded-xl mt-24 my-auto max-w-md border-2 border-gray-200 p-3 bg-white">
                {/* <!-- header -->   */}
                ...
                <form className="mb-4"  onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <NavLink to='/register' className="font-semibold text-indigo-500 focus:text-indigo-600 focus:outline-none focus:underline">Sign up</NavLink>.
                    </p>
                {/* <!-- seperator -->   */}
                ...
                <div className="flex flex-row gap-2">
                    <button className="bg-green-500 text-white w-full p-2 flex flex-row justify-center gap-2 items-center rounded-sm hover:bg-green-600 duration-100 ease-in-out" onClick={hundleGoogle}>
                    ...
                    <button onClick={hundleGithub} className="bg-gray-700 text-white w-full p-2 flex flex-row justify-center gap-2 items-center rounded-sm hover:bg-gray-800 duration-100 ease-in-out">
