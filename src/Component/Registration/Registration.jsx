        ...
        <div className="py-6 bg-gray-200">
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    ...
                    <div className="w-full p-8 lg:w-1/2">
                        <h2 className="text-2xl font-semibold text-gray-700 text-center">Welocome Back</h2>
                        ...
                        <div className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                            ...
                            <h1 className="px-4 py-3 w-5/6 text-center text-gray-600 font-bold" onClick={hundleGoogle}>Sign in with Google</h1>
                        </div>
                        <div className="mt-4 flex items-center justify-between">
                            <span className="border-b w-1/5 lg:w-1/4"></span>
                            <span className="text-xs text-center text-gray-500 uppercase">or Registration with email</span>
                            <span className="border-b w-1/5 lg:w-1/4"></span>
                        </div>
                       <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="mt-4">
                                ...
                                <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text"  {...register("img")}/>
                            </div>
                            <div className="mt-4">
                            ...
                            <div className="mt-4">
                                <div className="flex justify-between">
                                    ...
                                    <NavLink to='/forget-password' className="text-xs text-gray-500">Forget Password?</NavLink>
                                </div>
                                <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="password"  {...register("password",{ required: true ,maxLength:6})}/>
                            </div>
                            <div className="mt-8">
                        ...
                        <div className="mt-4 flex items-center justify-between">
                            ...
                            <NavLink to='/login' className="text-xs text-gray-500 uppercase">or sign up</NavLink>
                            <span className="border-b w-1/5 md:w-1/4"></span>
                        </div>
                    </div>
                </div>
