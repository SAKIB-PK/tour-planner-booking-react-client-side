...
const About = () => {
    return (
    <div className="font-sans antialiased text-gray-900 bg-gray-200 leading-normal tracking-wider bg-cover">
        ...
        <div className="w-full lg:w-2/5">
            ...
            <img src="https://i.imgur.com/CC5mBqd.png" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt='img icon'/>
